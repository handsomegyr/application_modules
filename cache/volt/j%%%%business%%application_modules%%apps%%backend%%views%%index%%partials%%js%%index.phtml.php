    ...
    return {
        ...
        initChat: function () {
            ...
            var handleClick = function (e) {
                ...
                var tpl = '';
                tpl += '<li class="out">';
                tpl += '<img class="avatar" alt="" src="<?php echo $resourceUrl; ?>media/image/avatar1.jpg"/>';
        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    image: '<?php echo $resourceUrl; ?>media/image/avatar1.jpg',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image1: '<?php echo $resourceUrl; ?>media/image/avatar1.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image1: '<?php echo $resourceUrl; ?>media/image/image1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image1: '<?php echo $resourceUrl; ?>media/image/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
