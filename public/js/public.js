$(function(){
	...
	$("#ulRToolList .f-back-to, #ulRToolList .f-feedback, #ulRToolList .f-weixin, #ulRToolList .f-client, #ulRToolList .f-customer-service").hover(function(){
		$(this).addClass('cart-hover');
		$("#divRTCartMain, #divRTColect").animate({"right":"-240px"});
	},function(){
	...
	// 加入购物车效果
	$(".u-cart, .consume-addcar").on("click",function(event){
