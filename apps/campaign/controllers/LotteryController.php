 ...
 *
 * 授权地址
 * http://www.myapplicationmodule.com/campaign/lottery/weixinauthorizebefore?callbackUrl=http%3A%2F%2Fwww.baidu.com%2F
 *
 * http://www.myapplicationmodule.com/campaign/lottery/weixinauthorizebefore?operation4cookie=clear
 *
 * http://www.myapplicationmodule.com/campaign/lottery/weixinauthorizebefore?operation4cookie=store&FromUserName=xxxx&nickname=xx&headimgurl=xx
 *
 * http://www.myapplicationmodule.com/html/lottery/index.html
 *
 * http://www.myapplicationmodule.com/campaign/lottery/weixinauthorizebefore?operation4cookie=store&FromUserName=ok0K2vystcQkKolNr3anJd-soVuI&nickname=郭永荣&headimgurl=xx
 *
 * @author 郭永荣
 *        
 */
class LotteryController extends ControllerBase
{
    ...
    {
        // http://www.myapplicationmodule.com/campaign/lottery/getcampaignuserinfo
        try {
            $this->view->disable();
    ...
    {
        // http://www.myapplicationmodule.com/campaign/lottery/lottery?name=guoyongrong&mobile=13564100096&address=xxx
        try {
            $this->view->disable();
            // 获取活动信息
            $activityInfo = $this->modelActivity->getActivityInfo2($this->activity_id, $this->now);
    ...
    {
        // http://www.myapplicationmodule.com/campaign/lottery/recorduserinfo?exchange_id=5865f1edfcc2b60a008b456c&identity_id=xxxx&name=guoyongrong&mobile=13564100096&address=shanghai
        try {
            $this->view->disable();
    ...
    {
        // http://www.myapplicationmodule.com/campaign/lottery/sendsms?exchange_id=5865f1edfcc2b60a008b456c&identity_id=xxxx&mobile=13564100096
        try {
            $this->view->disable();
    ...
    {
        // http://www.myapplicationmodule.com/campaign/lottery/testsendsms?code=xxxx&mobile=13564100096
        try {
            $this->view->disable();
    ...
    private function sendTemplateMsg($openid, $prize_name, $code)
    {
        try {
            ...
            $url = "{$this->webPath}tuanyuan/lottery/coupon";
            $topcolor = "#FF0000";
            $data = array();
            $data['first'] = array(
