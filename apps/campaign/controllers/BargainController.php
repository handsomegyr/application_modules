...
class BargainController extends ControllerBase
{
    ...
    {
        // http://www.applicationmodule.com:10080/campaign/bargain/get?bargain_id=58d4dd2af3b9530d008b4568
        try {
    ...
    {
        // http://www.applicationmodule.com:10080/campaign/bargain/getloglist?bargain_id=58d4dd2af3b9530d008b4568
        try {
            $bargain_id = $this->get("bargain_id", '');
            if (empty($bargain_id)) {
                echo $this->error(- 1, '砍价物ID为空');
    ...
    {
        // http://www.applicationmodule.com:10080/campaign/bargain/do?FromUserName=handsomegyr&nickname=handsomegyr&headimgurl=handsomegyr&bargain_id=58d4dd2af3b9530d008b4568
        try {
    ...
    {
        // http://www.applicationmodule.com:10080/campaign/bargain/close?bargain_id=58d4dd2af3b9530d008b4568&FromUserName=guoyongrong
        try {
            $FromUserName = $this->get('FromUserName', ''); // 砍价者微信号
