...
class VoteController extends ControllerBase
{
    ...
    {
        // http://www.myapplicationmodule.com/campaign/vote/index
    ...
    {
        // http://www.myapplicationmodule.com/campaign/vote/do?FromUserName=xxxx
        try {
    ...
    {
        // http://www.myapplicationmodule.com/campaign/vote/syncrankperoid
        try {
            set_time_limit(0);
