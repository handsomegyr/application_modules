 ...
 * @SWG\Swagger(
 *     basePath="/",
 *     host="www.myapplicationmodule.com",
 *     schemes={"http","https"},
...
class SwaggerController extends ControllerBase
{
    ...
    /**
     * @SWG\Get(
     *     path="/campaign/swagger/findbytags",
    ...
    /**
     * @SWG\Get(
     *     path="/campaign/swagger/findbystatus",
    ...
    /**
     * @SWG\Post(
     *   path="/campaign/swagger/updatewithform",
     *   tags={"Swagger1"},
    ...
    /**
     * @SWG\Post(
     *     path="/campaign/swagger/uploadfile",
