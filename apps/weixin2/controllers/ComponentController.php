...
class ComponentController extends ControllerBase
{
    ...
    {
        // http://www.applicationmodule.com/component/login.html
        ...
        // http://www.applicationmodule.com/weixinopen/api/component/login?component_appid=wxca8519f703c07d32&redirect=https%3A%2F%2Fwww.baidu.com%2F
    ...
    {
        // http://www.applicationmodule.com/component/bind.html
        ...
        // http://www.applicationmodule.com/weixinopen/api/component/bind?component_appid=wxca8519f703c07d32&redirect=https%3A%2F%2Fwww.baidu.com%2F
        $_SESSION['oauth_start_time'] = microtime(true);
        try {
            // 初始化
            $this->doInitializeLogic();
    ...
    {
        // http://www.applicationmodule.com/weixinopen/api/component/logincallback?auth_code=queryauthcode@@@YGWj2XtzxxwQQfpIW6VGOJvDALlLfFwSy9anTBQs0sEMXsXZMrTRVPbhXpmqh265vpKz_YIgj2bJ-WJR2oGABw&expires_in=3600
        try {
    ...
    {
        // http://www.applicationmodule.com/weixinopen/api/component/authorizecallback?component_appid=wxca8519f703c07d32
        try {
            // 兼容的写法
    ...
    {
        // http://www.applicationmodule.com/weixinopen/api/component/authorizer-token?component_appid=wxca8519f703c07d32&authorizer_appid=xxx
        try {
            // 初始化
            $this->doInitializeLogic();
    ...
    {
        // http://www.applicationmodule.com/weixinopen/api/component/get-component-access-token?component_appid=wxca8519f703c07d32
        try {
            // 初始化
            $this->doInitializeLogic();
