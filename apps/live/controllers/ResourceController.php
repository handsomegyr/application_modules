...
class ResourceController extends ControllerBase
{
    ...
    {
        // http://www.applicationmodule.com/live/resource/getrandom?type=1
        try {
            $type = $this->get('type', '');
            if (empty($type)) {
    ...
    {
        // http://www.applicationmodule.com/live/resource/getlist?next_id=xxxx&type=1
        try {
    ...
    {
        // http://www.applicationmodule.com/live/resource/removefromredis?id=xxxx
        try {
            $id = $this->get('id', '');
            if (empty($id)) {
    ...
    {
        // http://www.applicationmodule.com/live/resource/removeallfromredis&type=1
        try {
            $type = $this->get('type', '');
            if (empty($type)) {
