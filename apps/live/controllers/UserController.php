...
class UserController extends ControllerBase
{
    ...
    public function loginAction()
    {
        ...
        // http://www.applicationmodule.com/live/user/login?room_id=5a4f2686cb6ef462f64ee4a1&openid=xxx&nickname=郭永荣&headimgurl=http://qzapp.qlogo.cn/qzapp/221403/12EBD57369718EBF0CC9FC352C2969AB/100&unionid=uxxx&authtype=weixin&source=weixin&channel=weixin
        ...
        try {
            ...
            if ($authtype == 'anonymous') {
                ...
                // 检查是否锁定，如果没有锁定加锁
                $key = cacheKey(__FILE__, __CLASS__, __METHOD__, $openid);
