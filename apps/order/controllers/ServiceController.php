...
class ServiceController extends ControllerBase
{
    ...
    {
        try {
            // http://webcms.didv.cn/order/service/totalbuycount
    ...
    public function getuserbuynewlistAction()
    {
        ...
        // http://webcms.didv.cn/order/service/getuserbuynewlist?id=xxx&page=1&limit=9
        try {
            $id = ($this->get('id', ''));
    ...
    public function getuserbuylistbycodeAction()
    {
        ...
        // http://webcms.didv.cn/order/service/getuserbuylistbycode?codeID=xxxx&page=1&limit=9
        try {
    ...
    public function getuserbuylistbycodeendAction()
    {
        ...
        // http://webcms.didv.cn/order/service/getuserbuylistbycodeend?codeID=xxxx&page=1&limit=10
        try {
            $goods_id = $this->get('codeID', '');
            if (empty($goods_id)) {
                echo ($this->error(- 1, '商品ID为空'));
    ...
    public function gethistorybuyrecordAction()
    {
        ...
        // http://webcms.didv.cn/order/service/gethistorybuyrecord?page=1&limit=20&BTime=2016-01-01%2019:16:00&ETime=2016-01-01%2020:16:59.999
        try {
    ...
    public function getuserpagebuyrafpostAction()
    {
        ...
        // http://webcms.didv.cn/order/service/getuserpagebuyrafpost?type=0&userID=9563477&limit=5&page=1
        try {
            // 0 云购记录 1 获得的商品 2 晒单
    ...
    public function getlastestrecordAction()
    {
        ...
        // http://webcms.didv.cn/order/service/getlastestrecord&id=
        try {
            $id = ($this->get('id', ''));
            $page = intval($this->get('page', '1'));
    ...
    public function getmembercenterbuymessageAction()
    {
        ...
        // http://webcms.didv.cn/order/service/getmembercenterbuymessage?page=1&limit=5&state=0&beginTime=2015-12-15&endTime=2015-12-15&keyWords=xxx
        try {
    ...
    public function getmembercenteruserwinlistAction()
    {
        ...
        // http://webcms.didv.cn/order/service/getmembercenteruserwinlist?page=1&limit=5&beginTime=2015-12-15&endTime=2015-12-15
        try {
    ...
    {
        // http://webcms.didv.cn/order/service/confirmorderconsignee?order_no=xxx&consignee_id=xxx&message=xxx
        try {
    ...
    {
        // http://webcms.didv.cn/order/service/deliveryorder?order_no=xxx&express_no=xxx&user_id=xx&delivery_sn=227187853706&user_name=xx
        try {
            $order_no = ($this->get('order_no', ''));
            if (empty($order_no)) {
    ...
    {
        // http://webcms.didv.cn/order/service/confirmorderreceive?order_no=xxx
        try {
            $order_no = ($this->get('order_no', ''));
            if (empty($order_no)) {
                echo ($this->error(- 2, '订单NO为空'));
