...
class ServiceController extends ControllerBase
{
    ...
    public function getuserpointsdetaillistAction()
    {
        ...
        // http://www.myapplicationmodule.com/points/service/getuserpointsdetaillist?beginTime=2015-12-01&endTime=2015-12-01&page=1&limit=10
        try {
    ...
    {
        // http://www.myapplicationmodule.com/points/service/rechargepredeposit?predeposit=10
        try {
    ...
    {
        // http://www.myapplicationmodule.com/points/service/getmembercentercommissionlist?beginTime=2015-12-01&endTime=2015-12-01&page=1&limit=10
        try {
            $beginTime = $this->get('beginTime', '');
            if (empty($beginTime)) {
                echo ($this->error(-1, '开始时间为空'));
