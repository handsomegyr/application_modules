...
class ServiceController extends ControllerBase
{
    ...
    {
        // http://www.jizigou.com/message/service/insertuserprivatemsg?msgToUID=10605005&msgContent=hello
        try {
            // 会员登录检查
    ...
    public function getuserprivmsglistAction()
    {
        ...
        // http://www.jizigou.com/message/service/getuserprivmsglist?page=1&limit=5
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function getuserprivmsgdetaillistAction()
    {
        ...
        // http://www.jizigou.com/message/service/getuserprivmsgdetaillist?page=1&limit=5&sendUserID=9533390
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function deluserprivatemsgAction()
    {
        ...
        // http://www.jizigou.com/message/service/ignoreuserfriend?applyID=37233515
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function getusermessagelistAction()
    {
        ...
        // http://www.jizigou.com/message/service/getusermessagelist?page=1&limit=10
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function insertmsgAction()
    {
        ...
        // ({'code':1})
        // http://www.jizigou.com/message/service/insertmsg?msgTouserWeb=1010029819&msgContent=bbbbbb
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function getreplymsgpagebyuseridAction()
    {
        ...
        // http://www.jizigou.com/message/service/getreplymsgpagebyuserid?page=1&limit=10
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function deletereplymsgbyuseridAction()
    {
        ...
        // http://www.jizigou.com/message/service/deletereplymsgbyuserid&msgID=229135
        try {
    ...
    {
        // http://www.jizigou.com/message/service/getusermsgcount
        try {
            $this->view->disable();
    ...
    public function deleteusermessageAction()
    {
        ...
        // http://www.jizigou.com/message/service/deleteusermessage?msgID=37233515
        try {
            $msgID = ($this->get('msgID', ''));
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
