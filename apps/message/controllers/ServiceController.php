...
class ServiceController extends ControllerBase
{
    ...
    {
        // http://webcms.didv.cn/message/service/insertuserprivatemsg?msgToUID=10605005&msgContent=hello
        try {
            // 会员登录检查
    ...
    public function getuserprivmsglistAction()
    {
        ...
        // http://webcms.didv.cn/message/service/getuserprivmsglist?page=1&limit=5
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function getuserprivmsgdetaillistAction()
    {
        ...
        // http://webcms.didv.cn/message/service/getuserprivmsgdetaillist?page=1&limit=5&sendUserID=9533390
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function deluserprivatemsgAction()
    {
        ...
        // http://webcms.didv.cn/message/service/ignoreuserfriend?applyID=37233515
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function getusermessagelistAction()
    {
        ...
        // http://webcms.didv.cn/message/service/getusermessagelist?page=1&limit=10
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function insertmsgAction()
    {
        ...
        // ({'code':1})
        // http://webcms.didv.cn/message/service/insertmsg?msgTouserWeb=1010029819&msgContent=bbbbbb
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function getreplymsgpagebyuseridAction()
    {
        ...
        // http://webcms.didv.cn/message/service/getreplymsgpagebyuserid?page=1&limit=10
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function deletereplymsgbyuseridAction()
    {
        ...
        // http://webcms.didv.cn/message/service/deletereplymsgbyuserid&msgID=229135
        try {
    ...
    {
        // http://webcms.didv.cn/message/service/getusermsgcount
        try {
            $this->view->disable();
    ...
    public function deleteusermessageAction()
    {
        ...
        // http://webcms.didv.cn/message/service/deleteusermessage?msgID=37233515
        try {
            $msgID = ($this->get('msgID', ''));
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
