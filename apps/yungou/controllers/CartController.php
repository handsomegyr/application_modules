...
class CartController extends ControllerBase
{
    ...
    {
        // http://www.applicationmodule.com/yungou/cart/list
    ...
    {
        // http://www.applicationmodule.com/yungou/cart/payment?pay_sn=xxx
    ...
    {
        // http://www.applicationmodule.com/yungou/cart/weixinpay?id=xxx
    ...
    {
        // http://www.applicationmodule.com/yungou/cart/shopok?id=xxxx
        $this->view->setRenderLevel(\Phalcon\Mvc\View::LEVEL_ACTION_VIEW);
        $id = $this->get('id', '');
        if (! empty($id)) {
            $orderPayInfo = $this->modelOrderPay->getInfoById($id);
