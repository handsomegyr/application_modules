...
class AreaController extends ControllerBase
{
    ...
    {
        // http://www.applicationmodule.com/service/area/getprovinces
        try {
            // 获取省列表
    ...
    {
        // http://www.applicationmodule.com/service/area/getcitys?province=110000
        try {
    ...
    {
        // http://www.applicationmodule.com/service/area/getdistricts?city=130900
        try {
            $city = $this->get('city', '');
            // 获取省列表
