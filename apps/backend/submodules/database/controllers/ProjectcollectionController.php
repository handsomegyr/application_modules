 ...
 * @name 表管理
 */
class ProjectcollectionController extends \App\Backend\Controllers\FormController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['defaultSourceData'] = array(
            'name' => '是否是插件默认数据源',
            'data' => array(
                'type' => 'boolean',
                'length' => 1,
        ...
        $schemas['hookLastResponseResult'] = array(
            'name' => 'HOOK最近执行结果',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
        ...
        $schemas['isAllowHttpAccess'] = array(
            'name' => '是否开启HTTP访问权限',
            'data' => array(
                'type' => 'boolean',
                'length' => 1,
        ...
        $schemas['promissionDefinition'] = array(
            'name' => '开放权限设定',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
        ...
        $schemas['submitConfirmInfo'] = array(
            'name' => '提交确认消息',
            'data' => array(
                'type' => 'string',
                'length' => 255,
        ...
        $schemas['hiveResultCollection'] = array(
            'name' => '是否是HIVE集合',
            'data' => array(
                'type' => 'boolean',
                'length' => 1,
