 ...
 * @name 表结构管理
 */
class ProjectcollectionstructureController extends \App\Backend\Controllers\FormController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['rshCollectionDisplayField'] = array(
            'name' => '关联表显示字段',
            'data' => array(
                'type' => 'string',
                'length' => 255,
        ...
        $schemas['rshCollectionFatherField'] = array(
            'name' => '关联表父节点字段',
            'data' => array(
                'type' => 'string',
                'length' => 255,
        ...
        $schemas['rshCollectionValueField'] = array(
            'name' => '关联表提交字段',
            'data' => array(
                'type' => 'string',
                'length' => 255,
        ...
        $schemas['rshSearchCondition'] = array(
            'name' => '关联约束条件',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
        ...
        $schemas['linkageClearValueField'] = array(
            'name' => '联动清空字段(多字段,分隔)',
            'data' => array(
                'type' => 'string',
                'length' => 255,
        ...
        $schemas['linkageSetValueField'] = array(
            'name' => '联动赋值字段(多字段,分隔)',
            'data' => array(
                'type' => 'string',
                'length' => 255,
        ...
        $schemas['quickTargetCollection'] = array(
            'name' => '快捷录入表',
            'data' => array(
                'type' => 'string',
                'length' => 255,
