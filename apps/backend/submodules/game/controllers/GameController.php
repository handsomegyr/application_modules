 ...
 * @name 游戏
 */
class GameController extends \App\Backend\Controllers\FormController
{
    private $modelGame;
    ...
    protected function getSchemas()
    {
        ...
        $schemas['end_time'] = array(
            ...
            'data' => array(
                'type' => 'datetime',
                'length' => 19,
                'defaultValue' => getCurrentTime($now + 3600 * 24 - 1)
            ),
            'validation' => array(
                'required' => true
            ),
