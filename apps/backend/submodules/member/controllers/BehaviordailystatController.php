...
use App\Backend\Submodules\Member\Models\BehaviorDailyStat;

/**
 * @title({name="会员行为每日统计管理"})
 *
 * @name 会员行为每日统计管理
 */
class BehaviordailystatController extends \App\Backend\Controllers\FormController
{
    // 是否只读
    protected $readonly = false;
    private $modelBehaviorDailyStat;
    private $actTypeOptions = array();
    public function initialize()
    {
        $this->modelBehaviorDailyStat = new BehaviorDailyStat();
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['act_content_list'] = array(
            'name' => '行为发生的内容',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
    ...
    {
        return $this->modelBehaviorDailyStat;
    }
}
