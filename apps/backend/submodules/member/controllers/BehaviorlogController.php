...
use App\Backend\Submodules\Member\Models\BehaviorLog;
 ...
 * @name 会员行为日志管理
 */
class BehaviorlogController extends \App\Backend\Controllers\FormController
{
    // 是否只读
    protected $readonly = false;
    private $modelBehaviorLog;
    private $modelActivity;
    private $actTypeOptions = array();
    public function initialize()
    {
        $this->modelBehaviorLog = new BehaviorLog();
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['act_content_type'] = array(
            'name' => '行为内容类型',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
        ...
        $schemas['act_content_subtype'] = array(
            'name' => '行为内容子类型',
            'data' => array(
                'type' => 'string',
                'length' => 255,
