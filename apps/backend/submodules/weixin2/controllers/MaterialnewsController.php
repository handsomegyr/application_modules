...
class MaterialnewsController extends \App\Backend\Controllers\FormController
{
    ...
    protected function getSchemas()
    {
        ...
        $schemas['thumb_media_id'] = array(
            'name' => '图文消息的封面图片素材id（必须是永久mediaID）',
            'data' => array(
                'type' => 'string',
                'length' => 255,
                'defaultValue' => ''
        ...
        $schemas['digest'] = array(
            'name' => '图文消息的摘要，仅有单图文消息才有摘要，多图文此处为空',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
                'defaultValue' => ''
        ...
        $schemas['show_cover_pic'] = array(
            'name' => '是否显示封面，0为false，即不显示，1为true，即显示',
            'data' => array(
                'type' => 'boolean',
                'length' => 1,
                'defaultValue' => false
        ...
        $schemas['content'] = array(
            'name' => '图文消息的具体内容，支持HTML标签，必须少于2万字符，小于1M，且此处会去除JS',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
                'defaultValue' => ''
