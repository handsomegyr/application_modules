 ...
 * @name 图文分享转发分时数据
 */
class DatacubeusersharehourController extends BaseController
{
    ...
    {
        // http://www.myapplicationmodule.com/admin/weixin2/datacubeusersharehour/syncusersharehour?id=xxx
        try {
