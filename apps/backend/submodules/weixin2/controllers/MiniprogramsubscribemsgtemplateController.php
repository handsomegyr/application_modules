 ...
 * @name 订阅模板管理
 */
class MiniprogramsubscribemsgtemplateController extends BaseController
{
    ...
    {
        // http://www.applicationmodule.com/admin/weixin2/miniprogramsubscribemsgtemplate/synctemplatelist?id=xxx
        try {
            ...
            if ($this->request->isGet()) {
                ...
                $res = $weixinopenService->syncMicroappSubscribeMsgTemplateList();
