...
use App\Backend\Submodules\Weixin2\Models\AppchatMsg\News;
use App\Backend\Submodules\Weixin2\Models\AppchatMsg\AppchatMsg;
use App\Backend\Submodules\Weixin2\Models\Media\Media;

/**
 * @title({name="群聊会话消息图文设置"})
 *
 * @name 群聊会话消息图文设置
 */
class AppchatmsgnewsController extends BaseController
{
    private $modelNews;
    ...
    public function initialize()
    {
        ...
        $this->appchatMsgItems = $this->modelAppchatMsg->getAllByType("news", "_id");
