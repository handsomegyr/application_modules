 ...
 * @name 接口分析数据
 */
class DatacubeinterfacesummaryController extends \App\Backend\Controllers\FormController
{
    ...
    {
        // http://www.applicationmodule.com/admin/weixin2/datacubeinterfacesummary/syncinterfacesummary?id=xxx
        try {
            $this->view->disable();
