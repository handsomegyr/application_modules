 ...
 * @name 图文统计数据
 */
class DatacubeuserreadController extends \App\Backend\Controllers\FormController
{
    ...
    {
        // http://www.applicationmodule.com/admin/weixin2/datacubeuserread/syncuserread?id=xxx
        try {
