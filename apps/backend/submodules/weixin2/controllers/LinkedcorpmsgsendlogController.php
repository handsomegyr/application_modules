...
use App\Backend\Submodules\Weixin2\Models\LinkedcorpMsg\SendLog;
use App\Backend\Submodules\Weixin2\Models\LinkedcorpMsg\LinkedcorpMsg;
use App\Backend\Submodules\Weixin2\Models\LinkedcorpMsg\Type;
use App\Backend\Submodules\Weixin2\Models\Media\Media;
use App\Backend\Submodules\Weixin2\Models\Material\Material;

/**
 * @title({name="互联企业消息发送日志"})
 *
 * @name 互联企业消息发送日志
 */
class LinkedcorpmsgsendlogController extends BaseController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['linkedcorp_msg_name'] = array(
            'name' => '互联企业消息名称',
            'data' => array(
                'type' => 'string',
                'length' => 50,
        ...
        $schemas['toall'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => $this->trueOrFalseDatas,
                'help' => '表示是否发送给应用可见范围内的所有人（包括互联企业的成员），默认为0'
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '1',
        ...
        $schemas['keyword_linkedcorp_msg_type'] = array(
            'name' => '关键词互联企业消息类型',
            'data' => array(
                'type' => 'string',
                'length' => 20,
        ...
        $schemas['linkedcorp_msg_content'] = array(
            'name' => '互联企业消息内容',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
