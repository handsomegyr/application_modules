 ...
 * @name 消息发送概况数据
 */
class DatacubeupstreammsgController extends \App\Backend\Controllers\FormController
{
    ...
    {
        // http://www.applicationmodule.com/admin/weixin2/datacubeupstreammsg/syncupstreammsg?id=xxx
        try {
            $this->view->disable();
