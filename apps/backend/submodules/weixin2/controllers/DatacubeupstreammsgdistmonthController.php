 ...
 * @name 消息发送分布月数据
 */
class DatacubeupstreammsgdistmonthController extends BaseController
{
    ...
    {
        // http://www.myapplicationmodule.com.com/admin/weixin2/datacubeupstreammsgdistmonth/syncUpstreammsgdistmonth?id=xxx
        try {
