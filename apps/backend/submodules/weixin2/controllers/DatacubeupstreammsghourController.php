 ...
 * @name 消息分送分时数据
 */
class DatacubeupstreammsghourController extends BaseController
{
    ...
    {
        // http://www.myapplicationmodule.com/admin/weixin2/datacubeupstreammsghour/syncupstreammsghour?id=xxx
        try {
