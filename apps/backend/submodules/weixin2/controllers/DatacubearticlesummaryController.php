 ...
 * @name 图文群发每日数据
 */
class DatacubearticlesummaryController extends BaseController
{
    ...
    {
        // http://www.myapplicationmodule.com.com/admin/weixin2/datacubearticlesummary/syncarticlesummary?id=xxx
        try {
