...
class CommentreplylogController extends BaseController
{
    ...
    {
        // http://www.myapplicationmodule.com/admin/weixin2/commentlog/deletecommentreply?id=xxx
        try {
    ...
    {
        // http://www.myapplicationmodule.com/admin/weixin2/commentlog/addcommentreply?id=xxx
        try {
            $id = trim($this->request->get('id'));
            if (empty($id)) {
                return $this->makeJsonError("记录ID未指定");
