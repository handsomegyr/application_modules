 ...
 * @name 群发消息发送日志
 */
class MassmsgsendlogController extends \App\Backend\Controllers\FormController
{
    ...
    protected function getSchemas()
    {
        ...
        $schemas['is_to_all'] = array(
            'name' => '用于设定是否向全部用户发送，值为true或false，选择true该消息群发给所有用户，选择false可根据tag_id发送给指定群组的用户',
            'data' => array(
                'type' => 'boolean',
                'length' => 1,
                'defaultValue' => false
        ...
        $schemas['tag_id'] = array(
            'name' => '群发到的标签的tag_id，参见用户管理中用户分组接口，若is_to_all值为true，可不填写tag_id',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
                'defaultValue' => 0
        ...
        $schemas['touser'] = array(
            'name' => '填写图文消息的接收者，一串OpenID列表，OpenID最少2个，最多10000个',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
                'defaultValue' => ''
        ...
        $schemas['send_ignore_reprint'] = array(
            'name' => '图文消息被判定为转载时，是否继续群发。 1为继续群发（转载），0为停止群发。 该参数默认为0。',
            'data' => array(
                'type' => 'boolean',
                'length' => 1,
                'defaultValue' => false
        ...
        $schemas['msg_data_id'] = array(
            'name' => '消息的数据ID，，该字段只有在群发图文消息时，才会出现。可以用于在图文分析数据接口中，获取到对应的图文消息的数据，是图文分析数据接口中的msgid字段中的前半部分，详见图文分析数据接口中的msgid字段的介绍。',
            'data' => array(
                'type' => 'string',
                'length' => 255,
                'defaultValue' => ''
        ...
        $schemas['msg_status'] = array(
            'name' => '消息发送后的状态，SEND_SUCCESS表示发送成功，SENDING表示发送中，SEND_FAIL表示发送失败，DELETE表示已删除',
            'data' => array(
                'type' => 'string',
                'length' => 30,
                'defaultValue' => ''
