...
use App\Backend\Submodules\Weixin2\Models\Miniprogram\Qrcode\Type;
 ...
 * @name 小程序二维码
 */
class MiniprogramqrcodeController extends BaseController
{
    private $modelQrcode;
    ...
    {
        // http://www.myapplicationmodule.com/admin/weixin2/miniprogramqrcode/createqrcode?id=xxx
        try {
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['path'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '小程序页面路径，接口A和C所用，扫码进入的小程序页面路径，最大长度 128 字节，不能为空；对于小游戏，可以只传入 query 部分，来实现传参效果，如：传入 "?foo=bar"，即可在 wx.getLaunchOptionsSync 接口中的 query 参数获取到 {foo:"bar"}。',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['scene'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => "场景，接口B所用，最大32个可见字符，只支持数字，大小写英文以及部分特殊字符：!#$&'()*+,/:;=?@-._~，其它字符请自行编码为合法字符（因不支持%，中文无法使用 urlencode 处理，请使用其他编码方式）",
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['width'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '二维码的宽度，单位 px，最小 280px，最大 1280px',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['auto_color'] = array(
            ...
            'form' => array(
                ...
                'help' => '是否自动配置线条颜色，如果颜色依然是黑色，则说明不建议配置主色调，默认 false',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '1',
        ...
        $schemas['is_hyaline'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => $this->trueOrFalseDatas,
                'help' => '是否需要透明底色，为 true 时，生成透明底色的小程序',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '1',
