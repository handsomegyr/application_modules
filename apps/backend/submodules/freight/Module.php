...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            ...
            'App\Backend\Models\Freight' => __DIR__ . '/models/',
            'App\Backend\Controllers\Freight' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function ()
        {
            ...
            $dispatcher->setDefaultNamespace("App\Backend\Controllers\Freight");
