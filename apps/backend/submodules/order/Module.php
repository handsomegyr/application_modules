<?php
namespace Webcms\Backend\Order;
...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            ...
            'Webcms\Backend\Models\Freight' => APP_PATH . 'apps/backend/submodules/freight/models/',
            ...
            'Webcms\Backend\Models\Order' => __DIR__ . '/models/',
            'Webcms\Backend\Controllers\Order' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function ()
        {
            ...
            $dispatcher->setDefaultNamespace("Webcms\Backend\Controllers\Order");
