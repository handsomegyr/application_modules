...
use App\Backend\Submodules\Banner\Models\Item;
use App\Backend\Submodules\Banner\Models\Banner;

/**
 * @title({name="Banner子项目"})
 *
 * @name Banner子项目
 */
class ItemController extends \App\Backend\Controllers\FormController
{
    ...
    public function initialize()
    {
        ...
        $this->bannerList = $this->modelBanner->getAll();
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['end_at'] = array(
            'name' => '结束日期',
            'data' => array(
                'type' => 'datetime',
                'length' => 19,
                'defaultValue' => getCurrentTime($now + 2 * 3600 * 24 - 1)
            ),
            'validation' => array(
                'required' => true
            ),
