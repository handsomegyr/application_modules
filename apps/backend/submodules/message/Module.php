<?php
namespace Webcms\Backend\Message;
...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            ...
            'Webcms\Backend\Models\Message' => __DIR__ . '/models/',
            'Webcms\Backend\Controllers\Message' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function ()
        {
            ...
            $dispatcher->setDefaultNamespace("Webcms\Backend\Controllers\Message");
