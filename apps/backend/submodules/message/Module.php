...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            ...
            'App\Backend\Submodules\Message\Models' => __DIR__ . '/models/',
            'App\Backend\Submodules\Message\Controllers' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function ()
        {
            ...
            $dispatcher->setDefaultNamespace("App\Backend\Submodules\Message\Controllers");
