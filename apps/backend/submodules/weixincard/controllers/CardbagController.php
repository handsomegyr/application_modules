...
class CardbagController extends \App\Backend\Controllers\FormController
{
    ...
    {
        // http://www.applicationmodule.com:10080/admin/weixincard/CardBag/depositecode?card_id=p4ELSv5zS98NBYuq8D1l2HcgRou0
        try {
            $this->view->disable();
            $weixin = $this->getWeixin();
            $this->modelCardBag->setWeixin($weixin);
            ...
            // 导入自定义卡券code处理
            $this->modelCardBag->depositeCode($card_id);
