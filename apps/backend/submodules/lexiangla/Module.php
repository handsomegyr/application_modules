<?php
namespace App\Backend\Lexiangla;
...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->setNamespaces(array(
            ...
            'App\Backend\Submodules\Lexiangla\Controllers' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function () {
            ...
            $dispatcher->setDefaultNamespace("App\Backend\Submodules\Lexiangla\Controllers");
