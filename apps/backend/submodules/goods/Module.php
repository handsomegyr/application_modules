<?php
namespace Webcms\Backend\Goods;
...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            ...
            'Webcms\Backend\Models\Store' => APP_PATH . 'apps/backend/submodules/store/models/',
            ...
            'Webcms\Backend\Models\Goods' => __DIR__ . '/models/',
            'Webcms\Backend\Controllers\Goods' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function ()
        {
            ...
            $dispatcher->setDefaultNamespace("Webcms\Backend\Controllers\Goods");
