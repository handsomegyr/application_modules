...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            ...
            'App\Backend\Submodules\Bargain\Controllers' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function () {
            ...
            $dispatcher->setDefaultNamespace("App\Backend\Submodules\Bargain\Controllers");
