...
CREATE TABLE `ipayment_log` (
  ...
  `money` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '支付金额',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='支付-日志';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='支付-通知';
