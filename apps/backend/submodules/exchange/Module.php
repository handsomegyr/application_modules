<?php
namespace Webcms\Backend\Exchange;
...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            ...
            'Webcms\Backend\Models\Points' => APP_PATH . 'apps/backend/submodules/points/models/',
            ...
            'Webcms\Backend\Models\Exchange' => __DIR__ . '/models/',
            'Webcms\Backend\Controllers\Exchange' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function ()
        {
            ...
            $dispatcher->setDefaultNamespace("Webcms\Backend\Controllers\Exchange");
