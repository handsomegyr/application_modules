...
CREATE TABLE `iprize_category` (
  ...
  PRIMARY KEY (`_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='奖品-奖品类别';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='奖品-券码';
...
CREATE TABLE `iprize_prize` (
  ...
  `__REMOVED__` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='奖品-奖品';
