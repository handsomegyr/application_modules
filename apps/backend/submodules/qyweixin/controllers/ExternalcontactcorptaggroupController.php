...
use App\Backend\Submodules\Qyweixin\Models\ExternalContact\CorpTagGroup;
 ...
 * @name 企业标签组
 */
class ExternalcontactCorpTagGroupgroupController extends BaseController
{
    private $modelExternalcontactCorpTagGroup;

    public function initialize()
    {
        $this->modelExternalcontactCorpTagGroup = new CorpTagGroup();
        parent::initialize();
    }

    protected function getHeaderTools2($tools)
    {
        $tools['getcorptaggrouplist'] = array(
            'title' => '获取企业标签组库',
            'action' => 'getcorptaggrouplist',
            'is_show' => true,
            'is_export' => false,
     ...
     * @name 获取企业标签组库
     */
    public function getcorptaggrouplistAction()
    {
        // http://www.myapplicationmodule.com/admin/qyweixin/externalcontactcorptaggroup/getcorptagGrouplist
        try {
            ...
            if ($this->request->isGet()) {
                ...
                $provider_appid = trim($this->request->get('corptaggroup_provider_appid'));
                $authorizer_appid = trim($this->request->get('corptaggroup_authorizer_appid'));
                $agent_agentid = trim($this->request->get('corptaggroup_agent_agentid'));
    ...
    {
        $fields = array();
        $fields['corptaggroup_provider_appid'] = array(
            'name' => '第三方服务商应用ID',
            'validation' => array(
                'required' => true
            ),
        ...
        $fields['corptaggroup_authorizer_appid'] = array(
            'name' => '授权方应用ID',
            'validation' => array(
                'required' => true
            ),
        ...
        $fields['corptaggroup_agent_agentid'] = array(
            'name' => '微信企业应用ID',
            'validation' => array(
                'required' => true
            ),
    ...
    {
        return $this->modelExternalcontactCorpTagGroup;
    }
}
