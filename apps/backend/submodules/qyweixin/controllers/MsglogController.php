...
class MsglogController extends \App\Backend\Controllers\FormController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['RefundFreeCoinCount'] = array(
            'name' => '本次变动的免费券点数量',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
        ...
        $schemas['RefundPayCoinCount'] = array(
            'name' => '本次变动的付费券点数量',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
        ...
        $schemas['contact_NewUserID'] = array(
            'name' => '新的UserID',
            'data' => array(
                'type' => 'string',
                'length' => 50,
        ...
        $schemas['contact_Department'] = array(
            'name' => '成员部门列表',
            'data' => array(
                'type' => 'string',
                'length' => 1024,
        ...
        $schemas['contact_IsLeaderInDept'] = array(
            'name' => '所在部门是否为上级',
            'data' => array(
                'type' => 'string',
                'length' => 1024,
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '表示所在部门是否为上级，0-否，1-是，顺序与Department字段的部门逐一对应',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['contact_Position'] = array(
            'name' => '职位信息',
            'data' => array(
                'type' => 'string',
                'length' => 255,
        ...
        $schemas['contact_Status'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '激活状态：1=已激活 2=已禁用 4=未激活 已激活代表已激活企业微信或已关注微工作台（原企业号）',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['contact_Avatar'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '注：如果要获取小图将url最后的”/0”改成”/100”即可',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['contact_Telephone'] = array(
            'name' => '座机',
            'data' => array(
                'type' => 'string',
                'length' => 30,
        ...
        $schemas['contact_DeptName'] = array(
            'name' => '部门名称',
            'data' => array(
                'type' => 'string',
                'length' => 100,
        ...
        $schemas['contact_DeptParentId'] = array(
            'name' => '父部门id',
            'data' => array(
                'type' => 'string',
                'length' => 10,
        ...
        $schemas['contact_DeptOrder'] = array(
            'name' => '部门排序',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
        ...
        $schemas['contact_AddUserItems'] = array(
            'name' => '标签中新增的成员userid列表',
            'data' => array(
                'type' => 'string',
                'length' => 1024,
                'defaultValue' => ''
        ...
        $schemas['contact_DelUserItems'] = array(
            'name' => '标签中删除的成员userid列表',
            'data' => array(
                'type' => 'string',
                'length' => 1024,
                'defaultValue' => ''
        ...
        $schemas['contact_AddPartyItems'] = array(
            'name' => '标签中新增的部门id列表',
            'data' => array(
                'type' => 'string',
                'length' => 1024,
        ...
        $schemas['contact_DelPartyItems'] = array(
            'name' => '标签中删除的部门id列表',
            'data' => array(
                'type' => 'string',
                'length' => 1024,
        ...
        $schemas['external_contact_UserID'] = array(
            'name' => '企业服务人员的UserID',
            'data' => array(
                'type' => 'string',
                'length' => 50,
        ...
        $schemas['external_contact_ExternalUserID'] = array(
            'name' => '外部联系人的userid',
            'data' => array(
                'type' => 'string',
                'length' => 50,
        ...
        $schemas['external_contact_State'] = array(
            'name' => 'state参数',
            'data' => array(
                'type' => 'string',
                'length' => 50,
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '添加此用户的「联系我」方式配置的state参数，可用于识别添加此用户的渠道',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['external_contact_WelcomeCode'] = array(
            'name' => '欢迎语code',
            'data' => array(
                'type' => 'string',
                'length' => 255,
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => 'WelcomeCode 欢迎语code，可用于发送欢迎语',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
