...
use App\Backend\Submodules\Qyweixin\Models\AppchatMsg\SendLog;
...
/**
 * @title({name="群聊会话消息发送日志"})
 *
 * @name 群聊会话消息发送日志
 */
class AppchatmsgsendlogController extends BaseController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['appchat_msg_name'] = array(
            'name' => '群聊会话消息名称',
            'data' => array(
                'type' => 'string',
                'length' => 50,
        ...
        $schemas['keyword_appchat_msg_type'] = array(
            'name' => '关键词群聊会话消息类型',
            'data' => array(
                'type' => 'string',
                'length' => 20,
        ...
        $schemas['appchat_msg_content'] = array(
            'name' => '群聊会话消息内容',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
