 ...
 * @name 企业微信
 */
class ExternalcontactuserbehaviordatabyuseridController extends \App\Backend\Controllers\FormController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['new_apply_cnt'] = array(
            'name' => '发起申请数，成员通过「搜索手机号」、「扫一扫」、「从微信好友中添加」、「从群聊中添加」、「添加共享、分配给我的客户」、「添加单向、双向删除好友关系的好友」、「从新的联系人推荐中添加」等渠道主动向客户发起的好友申请数量。',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
                'defaultValue' => 0,
        ...
        $schemas['chat_cnt'] = array(
            'name' => '聊天总数， 成员有主动发送过消息的聊天数，包括单聊和群聊。',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
                'defaultValue' => 0,
        ...
        $schemas['reply_percentage'] = array(
            'name' => '已回复聊天占比，客户主动发起聊天后，成员在一个自然日内有回复过消息的聊天数/客户主动发起的聊天数比例，不包括群聊，仅在确有回复时返回。',
            'data' => array(
                'type' => 'decimal',
                'length' => 5,
                'defaultValue' => 0.00,
        ...
        $schemas['avg_reply_time'] = array(
            'name' => '平均首次回复时长，单位为分钟，即客户主动发起聊天后，成员在一个自然日内首次回复的时长间隔为首次回复时长，所有聊天的首次回复总时长/已回复的聊天总数即为平均首次回复时长，不包括群聊，仅在确有回复时返回。',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
                'defaultValue' => 0,
        ...
        $schemas['negative_feedback_cnt'] = array(
            'name' => '删除/拉黑成员的客户数，即将成员删除或加入黑名单的客户数。',
            'data' => array(
                'type' => 'integer',
                'length' => 11,
                'defaultValue' => 0,
