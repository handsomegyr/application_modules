...
use App\Backend\Submodules\Qyweixin\Models\ReplyMsg\SendLog;

use App\Backend\Submodules\Qyweixin\Models\Media\Media;
use App\Backend\Submodules\Qyweixin\Models\Material\Material;
use App\Backend\Submodules\Qyweixin\Models\Kf\Account;
use App\Backend\Submodules\Qyweixin\Models\ReplyMsg\Type;

/**
 * @title({name="被动回复用户消息发送日志"})
 *
 * @name 被动回复用户消息发送日志
 */
class ReplymsgsendlogController extends BaseController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['keyword_reply_msg_type'] = array(
            'name' => '关键词回复消息类型',
            'data' => array(
                'type' => 'string',
                'length' => 20,
