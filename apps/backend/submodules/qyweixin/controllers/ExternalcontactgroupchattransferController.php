...
class ExternalcontactgroupchattransferController extends BaseController
{
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/externalcontactgroupchattransfer/transfer?id=xxx
        try {
            ...
            if ($this->request->isGet()) {
                ...
                $res = $weixinopenService->groupChatTransfer($data['chat_id'], $data['new_owner']);
