...
class ExternalcontactcontactwayController extends BaseController
{
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/corpjoinqrcode/uploadmedia?id=xxx
        try {
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/corpjoinqrcode/uploadmediaimg?id=xxx
        try {
            $id = trim($this->request->get('id'));
            if (empty($id)) {
                return $this->makeJsonError("记录ID未指定");
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/corpjoinqrcode/addcontactway?id=xxx
        try {
            $id = trim($this->request->get('id'));
            if (empty($id)) {
                return $this->makeJsonError("记录ID未指定");
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/corpjoinqrcode/getcontactway?id=xxx
        try {
            $id = trim($this->request->get('id'));
            if (empty($id)) {
                return $this->makeJsonError("记录ID未指定");
