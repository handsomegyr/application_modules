 ...
 * @name 企业微信
 */
class ExternalcontactmsgtemplateController extends \App\Backend\Controllers\FormController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['chat_type'] = array(
            'name' => '群发任务的类型，默认为single，表示发送给客户，group表示发送给客户群',
            'data' => array(
                'type' => 'string',
                'length' => 20,
                'defaultValue' => '',
        ...
        $schemas['external_userid'] = array(
            'name' => '客户的外部联系人id列表，仅在chat_type为single时有效，不可与sender同时为空，最多可传入1万个客户',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
                'defaultValue' => '',
        ...
        $schemas['sender'] = array(
            'name' => '发送企业群发消息的成员userid，当类型为发送给客户群时必填',
            'data' => array(
                'type' => 'string',
                'length' => 255,
                'defaultValue' => '',
        ...
        $schemas['fail_list'] = array(
            'name' => '无效或无法发送的external_userid列表',
            'data' => array(
                'type' => 'json',
                'length' => 1024,
                'defaultValue' => '',
