...
use App\Backend\Submodules\Qyweixin\Models\ExternalContact\MomentComment;

/**
 * @title({name="客户朋友圈的互动数据"})
 *
 * @name 客户朋友圈的互动数据
 */
class ExternalcontactmomentcommentController extends BaseController
{
    private $modelExternalcontactMomentComment;

    public function initialize()
    {
        $this->modelExternalcontactMomentComment = new MomentComment();
        parent::initialize();
    }
    ...
    {
        return $this->modelExternalcontactMomentComment;
    }
}
