...
class ExternalcontactexternaluserremarkController extends BaseController
{
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/externalcontactexternaluserremark/uploadmedia?id=xxx
        try {
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/externalcontactexternaluserremark/remarkexternaluser?id=xxx
        try {
            $id = trim($this->request->get('id'));
            if (empty($id)) {
                return $this->makeJsonError("记录ID未指定");
