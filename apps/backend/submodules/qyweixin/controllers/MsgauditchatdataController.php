...
/**
 * @title({name="企业会话内容存档会话内容"})
 *
 * @name 企业会话内容存档会话内容
 */
class MsgauditchatdataController extends BaseController
{
    ...
    protected function getSchemas2($schemas)
    {
        ...
        $schemas['seq'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '消息的seq值，标识消息的序号。再次拉取需要带上上次回包中最大的seq。Uint64类型，范围0-pow(2,64)-1',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['encrypt_random_key'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '使用publickey_ver指定版本的公钥进行非对称加密后base64加密的内容，需要业务方先base64 decode处理后，再使用指定版本的私钥进行解密，得出内容。String类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $schemas['encrypt_chat_msg'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '消息密文。需要业务方使用将encrypt_random_key解密得到的内容，与encrypt_chat_msg，传入sdk接口DecryptData,得到消息明文。String类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $schemas['decrypt_key'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '企业私钥解密encrypt_random_key后的内容。String类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $actionOptions = array();
        $actionOptions['send'] = '发送消息';
        $actionOptions['recall'] = '撤回消息';
        $actionOptions['switch'] = '切换企业日志';
        ...
        $msgtypeOptions['text'] = '文本消息';
        $msgtypeOptions['image'] = '图片消息';
        $msgtypeOptions['revoke'] = '撤回消息';
        $msgtypeOptions['agree'] = '同意消息';
        $msgtypeOptions['disagree'] = '不同意消息';
        $msgtypeOptions['voice'] = '语音消息';
        $msgtypeOptions['video'] = '视频消息';
        $msgtypeOptions['card'] = '名片消息';
        $msgtypeOptions['location'] = '位置消息';
        $msgtypeOptions['emotion'] = '表情消息';
        $msgtypeOptions['file'] = '文件消息';
        $msgtypeOptions['link'] = '链接消息';
        $msgtypeOptions['weapp'] = '小程序消息';
        $msgtypeOptions['chatrecord'] = '会话记录消息';
        $msgtypeOptions['todo'] = '待办消息';
        $msgtypeOptions['vote'] = '投票消息';
        $msgtypeOptions['collect'] = '填表消息';
        $msgtypeOptions['redpacket'] = '红包消息';
        $msgtypeOptions['meeting'] = '会议邀请消息';
        $msgtypeOptions['switch'] = '切换企业消息';
        $msgtypeOptions['docmsg'] = '在线文档消息';
        $msgtypeOptions['markdown'] = 'MarkDown格式消息';
        $msgtypeOptions['news'] = '图文消息';
        $msgtypeOptions['calendar'] = '日程消息';
        $msgtypeOptions['mixed'] = '混合消息';
        $msgtypeOptions['meeting_voice_call'] = '音频存档消息';
        $msgtypeOptions['voip_doc_share'] = '音频共享文档消息';
        ...
        $schemas['agree_userid'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '同意/不同意协议者的userid，外部企业默认为external_userid。String类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $schemas['card_userid'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '名片所有者的id，同一公司是userid，不同公司是external_userid。String类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $emotiontypeOptions = array();
        $emotiontypeOptions['1'] = 'gif';
        $emotiontypeOptions['2'] = 'png';
        ...
        $schemas['emotion_type'] = array(
            ...
            'form' => array(
                'input_type' => 'radio',
                'is_show' => true,
                'items' => $emotiontypeOptions,
                'help' => '表情类型，png或者gif.1表示gif 2表示png。Uint32类型',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['item_type'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '每条聊天记录的具体消息类型：ChatRecordText/ ChatRecordFile/ ChatRecordImage/ ChatRecordVideo/ ChatRecordLink/ ChatRecordLocation',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['item_content'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '聊天消息内容。Json串，内容为对应类型的json。String类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $votetypeOptions = array();
        $votetypeOptions['101'] = '发起投票';
        $votetypeOptions['102'] = '参与投票';
        ...
        $schemas['vote_votetype'] = array(
            ...
            'form' => array(
                ...
                'help' => '投票类型.101发起投票、102参与投票。Uint32类型',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['vote_voteid'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '投票id，方便将参与投票消息与发起投票消息进行前后对照。String类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $collecttypeOptions['Text'] = '文本';
        $collecttypeOptions['Number'] = '数字';
        $collecttypeOptions['Date'] = '日期';
        $collecttypeOptions['Time'] = '时间';
        ...
        $schemas['collect_type'] = array(
            ...
            'form' => array(
                'input_type' => 'radio',
                'is_show' => true,
                'items' => $collecttypeOptions,
                'help' => '表项类型，有Text(文本),Number(数字),Date(日期),Time(时间)。String类型',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $redpackettypeOptions = array();
        $redpackettypeOptions['1'] = '普通红包';
        $redpackettypeOptions['2'] = '拼手气群红包';
        $redpackettypeOptions['3'] = '激励群红包';
        ...
        $schemas['redpacket_type'] = array(
            ...
            'form' => array(
                'input_type' => 'radio',
                'is_show' => true,
                'items' => $redpackettypeOptions,
                'help' => '红包消息类型。1 普通红包、2 拼手气群红包、3 激励群红包。Uint32类型',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $meetingtypeOptions['101'] = '发起会议邀请消息';
        $meetingtypeOptions['102'] = '处理会议邀请消息';
        ...
        $schemas['meeting_meetingtype'] = array(
            ...
            'form' => array(
                ...
                'help' => '会议消息类型。101发起会议邀请消息、102处理会议邀请消息。Uint32类型',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['meeting_meetingid'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '会议id。方便将发起、处理消息进行对照。uint64类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        //1 参加会议、2 拒绝会议、3 待定、4 未被邀请、5 会议已取消、6 会议已过期、7 不在房间内
        $meetingstatusOptions = array();
        $meetingstatusOptions['1'] = '参加会议';
        $meetingstatusOptions['2'] = '拒绝会议';
        $meetingstatusOptions['3'] = '待定';
        $meetingstatusOptions['4'] = '未被邀请';
        $meetingstatusOptions['5'] = '会议已取消';
        $meetingstatusOptions['6'] = '会议已过期';
        $meetingstatusOptions['7'] = '不在房间内';
        ...
        $schemas['meeting_status'] = array(
            ...
            'form' => array(
                ...
                'help' => '会议邀请处理状态。1 参加会议、2 拒绝会议、3 待定、4 未被邀请、5 会议已取消、6 会议已过期、7 不在房间内。Uint32类型',
            ),
            'list' => array(
                'is_show' => true,
                'list_type' => '',
        ...
        $schemas['switch_user'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '具体为切换企业的成员的userid。String类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $schemas['docmsg_creator'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '在线文档创建者。本企业成员创建为userid；外部企业成员创建为external_userid',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
        ...
        $schemas['mixed_mixed'] = array(
            ...
            'form' => array(
                ...
                'is_show' => true,
                'items' => '',
                'help' => '混合消息内容。可包含图片、文字、表情等多种消息。Object类型',
            ),
            'list' => array(
                'is_show' => false,
                'list_type' => '',
