...
use App\Backend\Submodules\Qyweixin\Models\Contact\TagUser;
...
{
    private $modelTagUser;

    public function initialize()
    {
        $this->modelTagUser = new TagUser();
        parent::initialize();
    }
