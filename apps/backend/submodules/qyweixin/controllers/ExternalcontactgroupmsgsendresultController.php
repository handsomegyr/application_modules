...
use App\Backend\Submodules\Qyweixin\Models\ExternalContact\GroupMsgSendResult;

/**
 * @title({name="企业群发成员执行结果"})
 *
 * @name 企业群发成员执行结果
 */
class ExternalcontactgroupmsgsendresultController extends BaseController
{
    private $modelExternalcontactGroupMsgSendResult;

    public function initialize()
    {
        $this->modelExternalcontactGroupMsgSendResult = new GroupMsgSendResult();
        parent::initialize();
    }
    ...
    {
        return $this->modelExternalcontactGroupMsgSendResult;
    }
}
