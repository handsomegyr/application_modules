...
class DepartmentuserController extends BaseController
{
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/departmentuser/getdepartmentusersimplelist
        try {
    ...
    {
        // http://www.applicationmodule.com/admin/qyweixin/departmentuser/getdepartmentuserdetaillist
        try {
            // 如果是GET请求的话返回modal的内容
            if ($this->request->isGet()) {
                // 构建modal里面Form表单内容
