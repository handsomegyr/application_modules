...
class ExternalcontactgroupchatController extends BaseController
{
    ...
    {
        // http://www.myapplicationmodule.com/admin/qyweixin/externalcontactgroupchat/getgroupchatlist
        try {
    ...
    {
        // http://www.myapplicationmodule.com/admin/qyweixin/externalcontactgroupchat/getgroupchatinfo?id=xxx
        try {
