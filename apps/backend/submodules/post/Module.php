...
class Module
{
    ...
    public function registerAutoloaders()
    {
        ...
        $loader->registerNamespaces(array(
            ...
            'Webcms\Backend\Models\Post' => __DIR__ . '/models/',
            'Webcms\Backend\Controllers\Post' => __DIR__ . '/controllers/'
        ));
    ...
    public function registerServices($di)
    {
        ...
        $di->set('dispatcher', function ()
        {
            ...
            $dispatcher->setDefaultNamespace("Webcms\Backend\Controllers\Post");
