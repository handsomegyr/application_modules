...
EOD;
     ...
     * /usr/bin/php /learn-php/phalcon/application_modules/public/cli.php companycut handle p001
     */
    public function handleAction(array $params)
    {
        ...
        // 测试用
        $taskInfo = array();
        $taskInfo['content'] = array('process_list' => 'create_project', 'project_code' => $project_code);
