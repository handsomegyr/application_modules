...
class ServiceController extends ControllerBase
{
    ...
    public function getrecpostlistAction()
    {
        ...
        // http://www.jizigou.com/post/service/getrecpostlist
        try {
    ...
    public function getpostoldperiodlistAction()
    {
        ...
        // http://www.jizigou.com/post/service/getpostoldperiodlist&page=1&limit=5&codeID=xxxx
        try {
    ...
    {
        // http://www.jizigou.com/post/service/getpostotherlist&page=1&limit=5&postid=xxxx
        try {
    ...
    public function getmembercenteruserpostsingleAction()
    {
        ...
        // http://www.jizigou.com/post/service/getmembercenteruserpostsingle?page=1&limit=5&state=0
        try {
    ...
    public function getpagelistpostsingleAction()
    {
        ...
        // http://www.jizigou.com/post/service/getpagelistpostsingle?page=1&limit=9
        try {
            $page = intval($this->get('page', '1'));
            $limit = intval($this->get('limit', '9'));
    ...
    public function insertpostsingleAction()
    {
        ...
        // http://www.jizigou.com/post/service/insertpostsingle?postCodeID=xxx&postTitle=&postContent=xxxx&postAllPic=a.pic,b.pic
        try {
            // 会员登录检查
    ...
    {
        // http://www.jizigou.com/post/service/insertpostreply?postid=125584&originalContent=运气很好运气很好&code=&refReplyId=0&refFloor=0
        // ({"code":0})
        // http://www.jizigou.com/post/service/insertpostreply?postid=125584&originalContent=真的很好&code=&refReplyId=1655353&refFloor=0
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function deletepostreplyAction()
    {
        ...
        // http://www.jizigou.com/post/service/deletepostreply?replyId=125584
        try {
    ...
    public function getpostreplybyidAction()
    {
        ...
        // http://www.jizigou.com/post/service/getpostreplybyid?page=1&limit=10&postid=125584
        try {
            $postid = ($this->get('postid', ''));
            $page = intval($this->get('page', '1'));
    ...
    public function getpostreplyinfoAction()
    {
        ...
        // http://www.jizigou.com/post/service/getpostreplyinfo?replyId=1655353
        try {
            $replyId = ($this->get('replyId', ''));
    ...
    public function insertposthitsAction()
    {
        ...
        // http://www.jizigou.com/post/service/insertposthits?postid=125584
        try {
            // 会员登录检查
            $isLogin = $this->modelMember->checkloginMember();
            if (! $isLogin) {
    ...
    public function getgoodspostlistAction()
    {
        ...
        // http://www.jizigou.com/post/service/getgoodspostlist?goodsID=22288&page=1&limit=10
        try {
    ...
    {
        // http://www.jizigou.com/order/service/passpost?post_id=xxx&point=800&is_recommend=1&user_id=xx&user_name=xx
        try {
