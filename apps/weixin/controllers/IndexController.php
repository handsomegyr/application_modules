...
class IndexController extends ControllerBase
{
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/callback
        try {
            /**
             * ==================================================================================
             * ====================================以下逻辑请勿修改===================================
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/syncmenu
        try {
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/syncconditionalmenu
        try {
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/createqrcode
        try {
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/sendtemplatemsg
        try {
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/getsettings
        try {
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/getjssdkinfo
        try {
            // 如果不是跨域请求的话
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/getaccesstoken
        try {
            if (empty($this->_appConfig)) {
                $this->_appConfig = $this->_app->getTokenByAppid($this->appid);
            }
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/getjsapiticket
        try {
            if (empty($this->_appConfig)) {
                $this->_appConfig = $this->_app->getTokenByAppid($this->appid);
            }
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/getcallbackip
        try {
            if (empty($this->_appConfig)) {
                $this->_appConfig = $this->_app->getTokenByAppid($this->appid);
            }
    ...
    {
        // http://www.myapplicationmodule.com/weixin/index/getuserinfo?FromUserName=o4ELSvz-B4_DThF0Vpfrverk3IpY
        try {
