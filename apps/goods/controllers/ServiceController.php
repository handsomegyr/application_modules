...
class ServiceController extends ControllerBase
{
    ...
    {
        // http://webcms.didv.cn/goods/service/createnewperiod?goods_commonid=563728bf7f50eab0040003e3
        try {
    ...
    {
        // http://webcms.didv.cn/goods/service/lottery?goods_id=563728be7f50eab0040003b1
        try {
    ...
    public function getgoodslistAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getgoodslist?sortID=0&brandID=0&orderFlag=10&limit=24&page=1
        try {
    ...
    public function getrecgoodslistAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getrecgoodslist?goodsLabel=12&quantity=8
        try {
    ...
    public function getbarcodernoinfoAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getbarcodernoinfo?codeID=2688851
        try {
    ...
    public function getstartrafflealllistAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getstartrafflealllist?time=xxxx&limit=5&page=1
        try {
    ...
    {
        // http://webcms.didv.cn/goods/service/getrafflecount
        try {
    ...
    public function getlotteryrecordsAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getlotteryrecords?codeId=2688851
        try {
            $goods_id = ($this->get('codeId', ''));
            if (empty($goods_id)) {
                echo ($this->error(- 1, '商品ID为空'));
    ...
    public function getlotterylistAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getlotterylist?limit=72&page=1&SortID=106
        try {
    ...
    public function getgoodsperiodpageAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getgoodsperiodpage?goodsID=22642&codeID=2575388&page=1&limit=100
        try {
    ...
    public function getgoodsperiodinfoAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getgoodsperiodinfo?goodsID=22642&period=100
        try {
            $goods_id = $this->get('goodsID', '');
            if (empty($goods_id)) {
                echo ($this->error(- 1, '商品ID为空'));
    ...
    public function getcollectgoodslistAction()
    {
        ...
        // http://webcms.didv.cn/goods/service/getcollectgoodslist?page=1&limit=15
        try {
            $page = intval($this->get('page', '1'));
    ...
    {
        try {
            // http://webcms.didv.cn/goods/service/addcollectgoods?goods_id=xxx
            $goods_id = ($this->get('goods_id', ''));
            if (empty($goods_id)) {
    ...
    public function delcollectgoodsAction()
    {
        try {
            ...
            // http://webcms.didv.cn/goods/service/delcollectgoods?goodsID=xxx
            $goods_id = ($this->get('goodsID', ''));
            if (empty($goods_id)) {
                echo ($this->error(- 2, '商品ID为空'));
                return false;
    ...
    {
        try {
            // http://webcms.didv.cn/goods/service/checkcollectgoods?goods_id=xxx
            $goods_id = ($this->get('goods_id', ''));
            if (empty($goods_id)) {
                echo ($this->error(- 2, '商品ID为空'));
                return false;
    ...
    {
        try {
            // http://webcms.didv.cn/goods/service/hascollectgoods
            if (empty($_SESSION['member_id'])) {
                echo ($this->error(- 1, '非法访问'));
                return false;
            }
