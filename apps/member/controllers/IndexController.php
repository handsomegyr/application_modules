...
class IndexController extends ControllerBase
{
    ...
    {
        // http://www.myapplicationmodule.com/member/index/index
        // 消息数
    ...
    {
        // http://www.myapplicationmodule.com/member/index/userrecharge
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/cardrecharge
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/userbuylist
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/userbuydetail?goods_id=xxx
    ...
    {
        // http://www.myapplicationmodule.com/member/index/orderlist
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/orderdetail?orderno=xxxx
    ...
    {
        // http://www.myapplicationmodule.com/member/index/postsinglelist
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/postsingleadd?goods_id=xxx
        $this->view->disableLevel(\Phalcon\Mvc\View::LEVEL_LAYOUT);
        $goods_id = $this->get('goods_id', '');
        if (empty($goods_id)) {
            die('error');
    ...
    {
        // http://www.myapplicationmodule.com/member/index/postsingleedit?goods_id=xxx
        $this->view->disableLevel(\Phalcon\Mvc\View::LEVEL_LAYOUT);
        $goods_id = $this->get('goods_id', '');
        if (empty($goods_id)) {
            die('error');
    ...
    {
        // http://www.myapplicationmodule.com/member/index/collectlist
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/userbalance
    ...
    {
        // http://www.myapplicationmodule.com/member/index/myfriends
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/searchfriends
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/joingroup
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/joingroup01
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/joingroup02
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/invitedlist
        $myInvitationInfo = $this->modelInvitation->getInfoByUserId($_SESSION['member_id'], YUNGOU_ACTIVITY_ID);
        $this->assign('invitationInfo', $myInvitationInfo);
    ...
    {
        // http://www.myapplicationmodule.com/member/index/commissionquery
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/memberpoints
    }
    ...
    {
        // http://www.myapplicationmodule.com/member/index/usermessage
        // 更新已读
    ...
    {
        // http://www.myapplicationmodule.com/member/index/friendsapply
        // 更新已读
    ...
    {
        // http://www.myapplicationmodule.com/member/index/replycommentsmsg
        // 更新已读
    ...
    {
        // http://www.myapplicationmodule.com/member/index/userprivmsg
        // 更新已读
    ...
    {
        // http://www.myapplicationmodule.com/member/index/userprivmsgdetail?senderUserID=xxx
