...
class FileController extends ControllerBase
{
    ...
    {
        // http://www.myapplicationmodule.com/service/file/index?id=xxxx&w=100&h=100&upload_path=post
    ...
    {
        // http://www.myapplicationmodule.com/service/file/upload?upload_path=post
        $uploadPath = $this->get('upload_path', '');
        $rst = array();
        if (!empty($_FILES)) {
