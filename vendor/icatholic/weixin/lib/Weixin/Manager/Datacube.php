...
class Datacube
{
    ...
    public function getUserSummary($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getusersummary', $params);
    ...
    public function getUserCumulate($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getusercumulate', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getArticleSummary($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getarticlesummary', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getArticleTotal($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getarticletotal', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUserRead($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getuserread', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUserReadHour($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getuserreadhour', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUserShare($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getusershare', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUserShareHour($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getusersharehour', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUpstreamMsg($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getupstreammsg', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUpstreamMsgHour($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getupstreammsghour', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUpstreamMsgWeek($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getupstreammsgweek', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUpstreamMsgMonth($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getupstreammsgmonth', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUpstreamMsgDist($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getupstreammsgdist', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getUpstreamMsgDistMonth($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getupstreammsgdistmonth', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getInterfaceSummary($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getinterfacesummary', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getInterfaceSummaryHour($begin_date, $end_date)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getinterfacesummaryhour', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getCardBizuinInfo($begin_date, $end_date, $cond_source = 1)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getcardbizuininfo', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function getCardMembercardInfo($begin_date, $end_date, $cond_source = 1)
    {
        ...
        $rst = $this->_request->post($this->_url . 'datacube/getcardmembercardinfo', $params);
        return $this->_client->rst($rst);
    }
}
