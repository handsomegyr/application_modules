...
class Template
{
    ...
    public function send($touser, $template_id, $url, $topcolor, array $data)
    {
        ...
        $params['data'] = $data;
        $rst = $this->_request->post($this->_url . 'message/template/send', $params);
    ...
    public function setIndustry($industry_id1, $industry_id2)
    {
        ...
        $rst = $this->_request->post($this->_url . 'template/api_set_industry', $params);
        return $this->_client->rst($rst);
    }
    ...
    {
        $params = array();
        $rst = $this->_request->get($this->_url . 'template/get_industry', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function addTemplate($template_id_short)
    {
        ...
        $rst = $this->_request->post($this->_url . 'template/api_add_template', $params);
        return $this->_client->rst($rst);
    }
    ...
    {
        $params = array();
        $rst = $this->_request->get($this->_url . 'template/get_all_private_template', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function delPrivateTemplate($template_id)
    {
        $params = array();
        $params['template_id'] = $template_id;
        $rst = $this->_request->post($this->_url . 'template/del_private_template', $params);
        return $this->_client->rst($rst);
    }
}
